...
Ext.define("CafeTownsend.mediator.touch.EmployeeDetailMediator", {
    ...
    config: {
        ...
        refs: {
            ...
            backButton:         "touchEmployeeDetailView #backButton",
            saveEmployeeButton: "touchEmployeeDetailView #saveEmployeeButton",
            deleteButton:       "touchEmployeeDetailView #deleteButton"
        },
