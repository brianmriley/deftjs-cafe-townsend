...
Ext.define("CafeTownsend.mediator.touch.EmployeeListMediator", {
    ...
    config: {
        ...
        refs: {
            employeeListView:   "touchEmployeeListView",
            logoutButton:       "touchEmployeeListView #logoutButton",
            newEmployeeButton:  "touchEmployeeListView #newEmployeeButton",
            list:               "touchEmployeeListView #list",
            searchInput:        "touchEmployeeListView #searchInput",

            employeeDetailView: "touchEmployeeDetailView"
        },
